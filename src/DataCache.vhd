...
architecture rtl of DataCache is
	...
	signal addressPointer : std_logic_vector(29 downto 0);
...
begin	
	...
	addressPointer <= dataAddress(31 downto 2);
	...
	combinational_proc: process(useEnabled, dataReadNotWrite, dataOperation, dataAddress)
	begin	
				...
				case dataOperation is
					when DATA_BYTE =>
						case alignment is
							...
							when "11" =>
								writtenWord <= word(31 downto 0) & writeData(7 downto 0);
